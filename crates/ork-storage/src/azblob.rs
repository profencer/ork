//! Azure Blob placeholder (ADR-0016). Real client ships in a follow-up ADR.
...
pub struct AzureBlobStub;

#[async_trait]
impl ArtifactStore for AzureBlobStub {
    ...
    async fn put(
        ...
        Err(OrkError::Unsupported(
            "Azure Blob backend not yet implemented (ADR-0016 stub)".into(),
        ))
    }
